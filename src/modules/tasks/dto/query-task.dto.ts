...
export class QueryTaskDto {
  ...
  @ApiProperty({ example: 1, description: 'Filtrar por ID de proyecto', required: false })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  project_id?: number;

  @ApiProperty({ example: 1, description: 'Filtrar por estado (0=Pendiente, 1=En espera, 2=En progreso, 3=En revisión, 4=Completado)', required: false })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  status?: number;
